...
CARPETA_EXTRAIDA = r"C:\Users\rcolr.BTS\Documents\UiPath\MyFirstRPA\extraido"      
SALIDA_EXCEL = r"C:\Users\rcolr.BTS\Documents\UiPath\MyFirstRPA\SEGUIMIENTOPACPARAMEJORAR.xlsx"
...
# Ejemplo de cómo se agregaría dentro de tu función principal
# -----------------------------------------------------------
...
def procesar_excel():
    ...
    if not pdfs_reporte:
        ...
        for ruta_pdf in pdfs_reporte:
            ...
            if resultado == "Adjudicado":
                ...
                # resultados.append((monto, "Adjudicado"))
                return [monto, "Adjudicado"]
            # else:
    ...
    # 4) Guardar resultados en Excel
        ...
        # ws = wb.active
        # # # ws.title = "Resultados"
        # # ws.append(["Monto Adjudicado", "Estado"])
        # for fila in resultados:
        #     # fila debería tener la forma: (empresa, monto, estado)
        #     ws.append(fila)
        
        # ws.cell(row=fila_excel, column=33, value=resultado)
        # ws.cell(row=fila_excel, column=34, value=monto)
        # wb.save(SALIDA_EXCEL)
        # print(f"\nResultados guardados en {SALIDA_EXCEL}")
